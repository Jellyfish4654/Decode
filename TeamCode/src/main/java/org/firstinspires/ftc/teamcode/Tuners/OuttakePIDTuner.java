...
//                guidingMotor.setPower(1);
                vel = tPStoRPM(Math.abs(outtakeMotor.getVelocity()));
                outtakeMotor.setVelocity(rPMtotPS(TARGET_RPM));
            }
            ...
            telemetry.addData("\tSet Velocity (ticks/sec)", TARGET_RPM);
...
//            telemetry.addData("\tF", outtakeMotor.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER).f);
            ...
            telemetry.addData("\tEncoder Velocity (rpm)", vel);
